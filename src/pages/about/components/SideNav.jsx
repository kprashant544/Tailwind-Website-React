      ...
      <div className="flex bg-[rgb(255,162,0)] w-[10%] h-screen overflow-auto pl-1.5 pr-[3px] py-[5px]">
        <ul>
          <li className="text-3xl list-none no-underline px-[15px] py-[18px]">
            <NavLink to="/about/side1">Side 1</NavLink>
          </li>
          <li className="text-3xl list-none no-underline px-[15px] py-[18px]">
            <NavLink to="/about/side2">Side 2</NavLink>
          </li>
          <li className="text-3xl list-none no-underline px-[15px] py-[18px]">
            <NavLink to="/about/side3">Side 3</NavLink>
          </li>
          <li className="text-3xl list-none no-underline px-[15px] py-[18px]">
            <NavLink to="/about/side4">Side 4</NavLink>
          </li>
          <li className="text-3xl list-none no-underline px-[15px] py-[18px]">
            <NavLink to="/about/side5">Side 5</NavLink>
          </li>
          <li className="text-3xl list-none no-underline px-[15px] py-[18px]">
            <NavLink to="/about/side6">Side 6</NavLink>
          </li>
          <li className="text-3xl list-none no-underline px-[15px] py-[18px]">
